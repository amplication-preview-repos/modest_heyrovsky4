...
@InputType()
class ConnectionCreateNestedManyWithoutStreamsInput {
...
export { ConnectionCreateNestedManyWithoutStreamsInput as ConnectionCreateNestedManyWithoutStreamsInput };
